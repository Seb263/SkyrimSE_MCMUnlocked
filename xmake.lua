...
-- project infos
local projectName = "MCM-Unlocked"
...
target(projectName)
	...
	add_rules("commonlibsse-ng.plugin", {
		name = projectName,
		author = "Seb263",
		description = "MCM Unlocked binaries"
	})
    ...
    add_files("extern/Papyrus/Base/SKI_ConfigManager.psc")
    add_files("extern/Papyrus/Base/SKI_ConfigManager.pex")
    add_files("extern/Papyrus/MCMRecorder/McmRecorder.psc")
    add_files("extern/Papyrus/MCMRecorder/McmRecorder.pex")
