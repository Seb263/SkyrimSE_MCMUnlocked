...
int function RegisterMod(SKI_ConfigBase a_menu, string a_modName)
	ObjectReference marker = MCMUnlocked.RegisterMarker(a_modName, (a_menu as Quest))
	If !marker
		Return -1
	EndIf
...
int function UnregisterMod(SKI_ConfigBase a_menu)
	...
	If (modID != "")
		MCMUnlocked.UnregisterMarker(modID, (a_menu as Quest))
	EndIf
endFunction
...
Debug.MessageBox("The 'MCM-Unlocked.dll' file was not found/loaded. This file is essential for MCM to function properly. Without it, the mod list will remain empty.\n\nIf you just uninstalled this mod, it means the 'SKI_ConfigManager.pex' file was not removed and is still present in the 'Data\\Scripts' folder. You will need to delete it manually.")
	EndIf
