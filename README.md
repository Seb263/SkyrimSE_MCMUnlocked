...
Removes SkyUI's 128 MCM menu limit and loads all MCMs in just a few seconds using a fast, dynamic allocation system. Allows renaming, reordering, and disabling MCM menus directly in-game for full customization. Fully compatible with SE, AE, and VR via SKSE.
